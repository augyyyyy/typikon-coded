...
BIBLE_METADATA = {
    ...
    "Judges": 21, "Jdg": 21,
    "Ruth": 4,
    "1 Samuel": 31, "1 Sam": 31, "2 Samuel": 24, "2 Sam": 24,
    "1 Kings": 22, "1 Kgs": 22, "2 Kings": 25, "2 Kgs": 25,
    "1 Chronicles": 29, "2 Chronicles": 36,
    "Ezra": 10, "Nehemiah": 13,
    "Tobit": 14, "Judith": 16, "Esther": 10,
    "1 Maccabees": 16, "2 Maccabees": 15,
    "Job": 42,
    "Proverbs": 31, "Prov": 31,
    "Ecclesiastes": 12, "Eccl": 12,
    "Song of Songs": 8, "Song of Solomon": 8,
...
def test_scripture_citations_bounds():
    ...
    for filepath in json_files:
        # Skip output files, almanacs, or historical footnotes databases
        if "almanac" in str(filepath) or "st_sergius" in str(filepath) or "propers_comparisons" in str(filepath) or "synodal_footnotes" in str(filepath):
            continue
