...
**Reference Files:** `vocabulary_standardization_matrix.md`, `Dolnytsky_Typikon_Master.md`, `Dolnytsky_Typikon_Master.md`
...
- **Rule:** `Dolnytsky_Typikon_Master.md` consistently uses **Tone I**, **Tone VII**, etc. without an extra hyphen when referring to the Octoechos tone.
