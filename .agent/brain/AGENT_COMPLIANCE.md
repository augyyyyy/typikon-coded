...
### 11.4 Dashboard Server Management Restriction
- You are strictly prohibited from starting or restarting the dashboard server locally during a session (e.g. running `server.py` or similar). Server execution is managed externally by the user.
