...
class ComplineMixin:
    ...
    def resolve_compline_troparia(self, context, rubrics):
        ...
        # In Lent (Clean Week), we might have different rules, but Typikon Dolnytsky_Typikon_Master.md:4.1.8.5 suggests Great Compline structure.
        # If Small Compline is used in Lent (Friday), logic might differ.
        
        # Standard Weekday Logic (Cheesefare, etc.)
        # Typikon Dolnytsky_Typikon_Master.md:1.4.1: "of the weekday, of the Temple, and 'O God of our fathers'"
    ...
    # ref: Dolnytsky_Typikon_Master.md:1.5.1.3
    ...
    @liturgical_source(dolnytsky="Dolnytsky_Typikon_Master.md:4.1.7")
